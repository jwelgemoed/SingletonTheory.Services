...
namespace ServiceStack.OrmLite.Tests
{
	...
	public class ShippersExample
	{
		...
		{
			//OrmLiteConfig.DialectProvider = OrmLiteConfig.DialectProvider.SqlExpression<Shipper>();
		...
		{
			using (IDbConnection db = ConfigSettings.ConnectionString.OpenDbConnection())
			{
				db.DropAndCreateTable<ShipperType>();
