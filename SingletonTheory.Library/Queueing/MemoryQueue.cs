...
{
	/// <summary>
	/// Implements a generic threadsafe synchronised queue
	/// </summary>
	...
	public sealed class MemoryQueue<T>
	{
		...
		/// <summary>
		/// Dequeues the object at the front of the LinkedList and waits for the specifed time.  
		...
		/// <summary>
		/// Dequeues the object at the front of the queue and waits for the specifed time.  
		/// If no object becomes available in this time, returns null
		/// </summary>
		...
		/// <summary>
		/// Dequeues the object at the front of the queue and waits indefinately
		/// </summary>
		public T Dequeue()
		{
